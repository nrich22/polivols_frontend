...
@Component({
  selector: 'app-logs-mobile-form',
  templateUrl: './logs-mobile-form.component.html',
  styleUrls: ['./logs-mobile-form.component.css']
})
export class LogsMobileFormComponent implements OnInit {
  form: FormGroup;
